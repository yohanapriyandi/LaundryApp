...
class TransactionController extends Controller
{
    ...
    public function completeItem(Request $request)
    {
        ...
        $transaction = DetailTransaction::with(['transaction_customer'])->find($request-id);
    ...
    public function makePayment(Request $request)
    {
        ...
        try {
            ...
            if ($request->via_deposit) {
                ...
                $transaction->customer()->update(['deposit' => $transaction->customer->depostit - $request->amount]);
            }else{
            ...
            return response()->json(['status' => 'failes', 'data' => $e->getMessage()]);
        }
    }
}
