<template>
    <div>
        <div class="form-group" :class="{ 'has-error': errors.name }">
            ...
            <input type="text" class="form-control" v-model="product.name" placeholder="Jenis Baju">
        ...
        <div class="form-group" :class="{ 'has-error': errors.unit_type }">
            ...
            <select v-model="product.unit_type" class="form-control">
                ...
                <option value="Potong">Potong - (Pt)</option>
            </select>
            <p class="text-danger" v-if="errors.unnit_type">{{ errors.unit_type[0] }}</p>
        </div>
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="form-group" :class="{ 'has-error': errors.price }">
            ...
            <input type="number" class="control-form" v-model="product.price">
            <p class="text-danger" v-if="errors.proce">{{ errors.price }}</p>
        </div>
    </div>
