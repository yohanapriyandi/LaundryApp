                        ...
                        <div class="panel">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="role_selected">
                                    ...
                                    <p class="text-dager" v-if="errors.role_id">{{ errors.role_id[0] }}</p>
                                </select>
                            </div>
                            <div class="pull-right">
                                    <button class="btn btn-info btn-sm btn-flat" @click="checkPermission">
                                        <i class="fa fa-check-square-o"></i> {{ loading ? 'Loading...':'Check Permission' }}
                                    </button>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="pull-right">
                                <button class="btn btn-info btn-sm btn-flat" @click="setPermission">
