            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6" v-if="transaction.status == 0">
                        ...
                        <p v-if="isCustomerChange"> Sisa Pembayaran: Rp. {{ customerChangeAmount }}</p>
                        <div class="form-group" v-if="isCustomerChange">
                            <input type="checkbox" v-model="customer_change" id="customer_change">
                            <label for="customer_change">Apakah sisa pembayaran ingin dijadikan deposit?</label>
                        </div>
                    ...
                    <div class="col-md-6" v-if="transaction.payment">
                        ...
                        <table>
                             <tr>
                                <td width="30%"> Jumlah Pembayaran </td>
                                <td width="5%"> : </td>
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(row, index) in transaction.detail" :key="index">
                                        <td>
                                            ...
                                            <sup v-html="row.status.label"></sup>
                                        </td>
                                        <td>{{ row.service_time }}</td>
                                        <td>{{ row.qty }} {{ row.product.unit_type }}</td>
