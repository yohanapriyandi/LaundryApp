    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <router-link :to="{ name: 'customers.add' }" class="btn btn-microsoft btn-sm btn-flat">Tambah</router-link>
            ...
            <div class="panel-body">
                <b-table striped hover bordered :items="customers.data" :fields="fields" show-empty>
                    ...
                    <template slot="actions" slot-scope="row">
                        <router-link :to="{ name: 'customers.edit', params: {id: row.item.id} }" class="btn btn-microsoft btn-xs"><i class="fa fa-pencil"></i></router-link>
                        <button class="btn btn-danger btn-xs" @click="deleteCustomer(row.item.id)"><i class="fa fa-trash"></i></button>
                    </template>
                </b-table>
